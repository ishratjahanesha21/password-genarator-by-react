...
const Passwordgenaretor = () => {
    ...
    const [chatecteradd, setchatecteradd] =useState(false)
...
setpassword(pass)
    ...
    [length,numberadd,chatecteradd ,setpassword])
    ...
    const copyPasswordToClipboard = useCallback(() => {
      ...
      useEffect(()=>{
    passwordgenaretor()
  },[length,numberadd,chatecteradd,passwordgenaretor])
    ...
    <div className='flex text-sm gap-x-2'>
      ...
      <div className="flex items-center gap-x-1">
          <input
              type="checkbox"
              id="characterInput"
              onChange={()=>{setchatecteradd((pre)=>!pre)}}
          />
